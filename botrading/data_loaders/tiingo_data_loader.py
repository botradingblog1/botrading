...
from ..enums import TiingoInterval, DataType
...
class TiingoDataLoader:
    ...
    def fetch_tiingo_prices(self, symbol: str, interval: TiingoInterval, start_date: str, end_date: str, cache_data = False, cache_dir: str = "cache") -> pd.DataFrame:
        """
        ...
        try:
            ...
            if cache_data is True and os.path.exists(path):
                ...
                fetch_url = f"https://api.tiingo.com/tiingo/daily/{symbol}/prices?startDate={start_date}&endDate={end_date}&resampleFreq={interval.value}&token={self.api_key}"
